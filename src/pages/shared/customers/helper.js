import { cpfMask, phoneMask, cpfValidation, confirmPasswordValidation, cepMask } from 'utils/index';
import { alterInputAndAttributes } from 'pages/shared/helper';
...
export const inputMapPersonData = alterInputAndAttributes(inputMap[0], ['password', 'passwordRedundancy'], { email: { readOnly: true } });
